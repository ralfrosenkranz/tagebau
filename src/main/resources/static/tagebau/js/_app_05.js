        ...
        try {
            ...
            if (prod) {
                ...
                if (priceEl) {
                    ...
                    markDynamicResult(priceEl, amount);
                }
                if (descEl) {
                    dynText(descEl, (prod.description || prod.technicalName || ""));
                }
            }
        } catch (e) {
        ...
        if (gallery) {
            ...
            try {
                ...
                if (Array.isArray(imgs) && imgs.length) {
                    ...
                    var urls = imgs.map(function (mi) {
                        return safeUrl(mi.file || mi.url || mi.path);
                    }).filter(Boolean);
                    if (urls.length) {
                        // URLs exist
